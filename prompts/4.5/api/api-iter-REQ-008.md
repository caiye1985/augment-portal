...
1. **核心参考文档**：
   ...
   - 当前模块 PRD：`docs/prd/split/4.5/modules/REQ-008.md`
...
**路径**：`docs/api/modules/REQ-008-系统设置/openapi.yaml`
...
### 输出要求
1. 输出完整的 `docs/api/modules/REQ-008-系统设置/openapi.yaml` 文件内容。
...
### 验证命令
```bash
swagger-cli validate docs/api/modules/REQ-008-系统设置/openapi.yaml
