...
**路径**：`docs/api/modules/REQ-005-知识库管理系统/openapi.yaml`
...
### 输出要求
1. 输出完整的 `docs/api/modules/REQ-005-知识库管理系统/openapi.yaml` 文件内容。
...
### 验证命令
```bash
swagger-cli validate docs/api/modules/REQ-005-知识库管理系统/openapi.yaml
